...
document.addEventListener("DOMContentLoaded", (e) => {
    ...
    parametersOne.addEventListener('change', e => {
        ...
        if (profilOneIndex === 1 && colourOptionsIndex === 1 && steklopaketOneIndex > 0 && furnituraOneIndex > 0) {
            obj1 = objOneWds5;
        } else if (profilOneIndex === 2 && colourOptionsIndex === 1 && steklopaketOneIndex > 0 && furnituraOneIndex > 0) {
            obj1 = objOneWds6;
        } else if (profilOneIndex === 3 && colourOptionsIndex === 1 && steklopaketOneIndex > 0 && furnituraOneIndex > 0) {
            obj1 = objOneWds7;
        } else if (profilOneIndex === 1 && colourOptionsIndex === 2 && steklopaketOneIndex > 0 && furnituraOneIndex > 0) {
            obj1 = objOneWds5Coloured;
        } else if (profilOneIndex === 2 && colourOptionsIndex === 2 && steklopaketOneIndex > 0 && furnituraOneIndex > 0) {
            obj1 = objOneWds6Coloured;
        } else if (profilOneIndex === 3 && colourOptionsIndex === 2 && steklopaketOneIndex > 0 && furnituraOneIndex > 0) {
            obj1 = objOneWds7Coloured;
        }
    }
    );
    ...
    parametersTwo.addEventListener('change', e => {
        ...
        if (profilTwoIndex === 1 && colourOptionsIndexTwo === 1 && steklopaketTwoIndex > 0 && furnituraTwoIndex > 0) {
            obj2 = objTwoWds5;
        } else if (profilTwoIndex === 2 && colourOptionsIndexTwo === 1 && steklopaketTwoIndex > 0 && furnituraTwoIndex > 0) {
            obj2 = objTwoWds6;
        } else if (profilTwoIndex === 3 && colourOptionsIndexTwo === 1 && steklopaketTwoIndex > 0 && furnituraTwoIndex > 0) {
            obj2 = objTwoWds7;
        } else if (profilTwoIndex === 1 && colourOptionsIndexTwo === 2 && steklopaketTwoIndex > 0 && furnituraTwoIndex > 0) {
            obj2 = objTwoWds5Coloured;
        } else if (profilTwoIndex === 2 && colourOptionsIndexTwo === 2 && steklopaketTwoIndex > 0 && furnituraTwoIndex > 0) {
            obj2 = objTwoWds6Coloured;
        } else if (profilTwoIndex === 3 && colourOptionsIndexTwo === 2 && steklopaketTwoIndex > 0 && furnituraTwoIndex > 0) {
            obj2 = objTwoWds7Coloured;
        }
    });
    ...
    parametersThree.addEventListener('change', e => {
        ...
        if (profilThreeIndex === 1 && colourOptionsIndexThree === 1 && steklopaketThreeIndex > 0 && furnituraThreeIndex > 0) {
            obj3 = objThreeWds5;
        } else if (profilThreeIndex === 2 && colourOptionsIndexThree === 1 && steklopaketThreeIndex > 0 && furnituraThreeIndex > 0) {
            obj3 = objThreeWds6;
        } else if (profilThreeIndex === 3 && colourOptionsIndexThree === 1 && steklopaketThreeIndex > 0 && furnituraThreeIndex > 0) {
            obj3 = objThreeWds7;
        } else if (profilThreeIndex === 1 && colourOptionsIndexThree === 2 && steklopaketThreeIndex > 0 && furnituraThreeIndex > 0) {
            obj3 = objThreeWds5Coloured;
        } else if (profilThreeIndex === 2 && colourOptionsIndexThree === 2 && steklopaketThreeIndex > 0 && furnituraThreeIndex > 0) {
            obj3 = objThreeWds6Coloured;
        } else if (profilThreeIndex === 3 && colourOptionsIndexThree === 2 && steklopaketThreeIndex > 0 && furnituraThreeIndex > 0) {
            obj3 = objThreeWds7Coloured;
        }
    });
    ...
    function calculate(inputHeightOne, inputWidthOne) {
        ...
        if (h === 0 && w > 0) {
            price = obj1[widthAmountOne[w1]][h];
        } if (h === 0 && w == maxElW) {
            price = obj1[widthAmountOne[w]][h];
        } if (h === 0 && w === 0) {
            price = obj1[widthAmountOne[w]][h];
        } if (w === 0 && h > 0 && h !== maxElH) {
            price = obj1[widthAmountOne[w]][h1];
        } if (w === 0 && h === maxElH) {
            price = obj1[widthAmountOne[w]][h];
        } if (h === maxElH && w > 0 && w !== maxElW) {
            price = obj1[widthAmountOne[w1]][h];
        }
        if (h > 0 && w > 0 && h !== maxElH && w !== maxElW) {
            price = obj1[widthAmountOne[w1]][h1];
        }
    ...
    function calculateTwo(inputHeightTwo, inputWidthTwo) {
        ...
        let price;
        if (h2 === 0 && w2 > 0) {
            price = obj2[widthAmountTwo[wTwo]][h2];
        } if (h2 === 0 && w2 == maxElTwoW) {
            price = obj2[widthAmountTwo[w2]][h2];
        } if (h2 === 0 && w2 === 0) {
            price = obj2[widthAmountTwo[w2]][h2];
        } if (w2 === 0 && h2 > 0 && h2 !== maxElTwoH) {
            price = obj2[widthAmountTwo[w2]][hTwo];
        ...
        if (h2 > 0 && w2 > 0 && w2 !== maxElTwoW && h2 !== maxElTwoH) {
            price = obj2[widthAmountTwo[wTwo]][hTwo];
        }
        if (h2 > 0 && w2 > 0 && w2 == maxElTwoW && h2 !== maxElTwoH) {
            price = obj2[widthAmountTwo[wTwo]][h2];
        }
    ...
    function calculateThree(inputHeightThree, inputWidthThree) {
        ...
        let price;
        if (h3 === 0 && w3 > 0) {
            price = obj3[widthAmountThree[wThree]][h3];
        } if (h3 === 0 && w3 == maxElThreeW) {
            price = obj3[widthAmountThree[w3]][h3];
        } if (h3 === 0 && w3 === 0) {
            price = obj3[widthAmountThree[w3]][h3];
        } if (w3 === 0 && h3 > 0 && h3 !== maxElThreeH) {
            price = obj3[widthAmountThree[w3]][hThree];
        ...
        if (h3 > 0 && w3 > 0 && w3 !== maxElThreeW && h3 !== maxElThreeH) {
            price = obj3[widthAmountThree[wThree]][hThree];
        }
        if (h3 > 0 && w3 > 0 && w3 == maxElThreeW && h3 !== maxElThreeH) {
            price = obj3[widthAmountThree[wThree]][h3];
        }
